...
(function initI18n() {
  ...
  const TR_MODULES_SMILE = Object.assign({}, TR_COMMON, {
    ...
    "AI Smile Design": "AI Gülüş Tasarımı",
    "Show patients their new smile before they book": "Hastalarınıza randevu almadan önce yeni gülüşlerini gösterin",
    "Upload a photo at the chair or in the inbox. The AI returns a before/after preview in seconds — and your patient sees the result while they are still deciding.": "Fotoğrafı koltukta ya da gelen kutusunda yükleyin. AI, öncesi/sonrası önizlemesini saniyeler içinde döndürür — hastanız sonucu hâlâ karar aşamasındayken görür.",
    "Buy Smile Design": "Gülüş Tasarımını Al",
    ...
    "Instant WhatsApp sharing": "Anında WhatsApp paylaşımı",
    "The preview lands in the conversation you are already having, so the follow-up happens while interest is high.": "Önizleme, zaten sürdürdüğünüz konuşmanın içine düşer; böylece takip, ilgi yüksekken gerçekleşir.",
  ...
  const TR_MODULES_SOCIAL = Object.assign({}, TR_COMMON, {
    ...
    "Social Media AI": "Sosyal Medya AI",
    "Your clinic posts every day — without you lifting a finger": "Kliniğiniz her gün paylaşım yapar — siz parmağınızı bile kıpırdatmadan",
    "Give the AI a topic once. It writes the captions, applies your brand kit, fills the week's calendar and publishes on schedule while your team treats patients.": "AI'ya konuyu bir kez verin. Ekibiniz hastalarla ilgilenirken metinleri yazar, marka kitinizi uygular, haftalık takvimi doldurur ve planlanan saatte yayınlar.",
    "Buy Social Media AI": "Sosyal Medya AI'yı Al",
    "See how it works": "Nasıl çalıştığını görün",
    ...
    "How it works": "Nasıl çalışır",
    "You brief it once a month. It runs the rest of the week on its own.": "Ayda bir kez brief verirsiniz. Haftanın geri kalanını kendi başına yürütür.",
