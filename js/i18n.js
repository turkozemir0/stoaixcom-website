...
(function initI18n() {
  ...
  const TR_MODULES = Object.assign({}, TR_COMMON, {
    ...
    'Patients hesitate when they can\'t picture the result. Show them their new smile on WhatsApp in seconds — automatically or with one tap — and turn interest into a booking.': 'Hastalar sonucu gözlerinde canlandıramadığında tereddüt eder. Onlara yeni gülüşlerini saniyeler içinde WhatsApp\'tan gösterin — otomatik ya da tek dokunuşla — ve ilgiyi randevuya çevirin.',
    ...
    'Auto & manual WhatsApp send': 'Otomatik ve manuel WhatsApp gönderimi',
    'Buy Smile Design': 'Gülüş Tasarımını Al',
    'Social Media AI': 'Sosyal Medya AI',
    'No time, and no social media manager? AI runs your Instagram and Facebook on-brand and on schedule — you just approve.': 'Vaktiniz yok, sosyal medya yöneticiniz de mi yok? AI, Instagram ve Facebook\'unuzu markanıza uygun ve zamanında yönetir — siz yalnızca onaylarsınız.',
    ...
    /* ── Add-on Modules hub (yeni bölümler) ───────────────── */
    "Modules — STOAIX": "Modüller — STOAIX",
    "Turn browsers into booked patients — one AI tool at a time.": "Ziyaretçileri randevulu hastalara dönüştürün — her seferinde bir AI aracıyla.",
    "Add just the tool you need today. No contract, cancel anytime, instant access on any clinic account.": "Bugün yalnızca ihtiyacınız olan aracı ekleyin. Sözleşme yok, istediğiniz zaman iptal, her klinik hesabında anında erişim.",
    "See the tools in action": "Araçları canlı görün",
    "Compare plans": "Planları karşılaştırın",

    "See both modules working — right here.": "Her iki modülü de burada, çalışırken görün.",
    "Drag the slider. Watch the posts write themselves. This is exactly what your team gets on day one.": "Sürgüyü kaydırın. Gönderilerin kendiliğinden yazılışını izleyin. Ekibinizin ilk günden elde ettiği tam olarak budur.",
    "Live preview": "Canlı önizleme",
    "After — AI preview": "Sonrası — AI önizlemesi",
    "Before — patient photo": "Öncesi — hasta fotoğrafı",
    "Try a sample": "Bir örnek deneyin",
    "Before and after comparison": "Öncesi ve sonrası karşılaştırması",
    "Sample case 1": "Örnek vaka 1",
    "Sample case 2": "Örnek vaka 2",
    "Sample case 3": "Örnek vaka 3",
    "Upload photo": "Fotoğrafı yükleyin",
    "AI processing": "AI işliyor",
    "Send to patient": "Hastaya gönderin",
    "Share on WhatsApp": "WhatsApp'tan paylaş",
    "Photo in, new smile out — then straight into the patient's WhatsApp while they're still interested.": "Fotoğraf girer, yeni gülüş çıkar — sonra hasta hâlâ ilgiliyken doğrudan WhatsApp'ına gider.",
    "How it works →": "Nasıl çalışır →",

    "Teeth whitening promo": "Diş beyazlatma kampanyası",
    "Implant Q&A": "İmplant Soru-Cevap",
    "Patient story": "Hasta hikâyesi",
    "Brand kit": "Marka kiti",
    "This week": "Bu hafta",
    "Mon": "Pzt", "Tue": "Sal", "Wed": "Çar", "Thu": "Per", "Fri": "Cum", "Sat": "Cmt", "Sun": "Paz",
    "Auto-published to Instagram & Facebook": "Instagram ve Facebook'ta otomatik yayınlandı",
    "Whiter smile in one visit — book this week and save 20%.": "Tek seansta daha beyaz gülüş — bu hafta randevu alın, %20 tasarruf edin.",
    "Coffee, tea, time. Professional whitening fixes all three.": "Kahve, çay, zaman. Profesyonel beyazlatma üçünü de çözer.",
    "Before your wedding photos: a whitening session takes 45 minutes.": "Düğün fotoğraflarınızdan önce: beyazlatma seansı 45 dakika sürer.",
    "Do implants hurt? Our patients describe it as easier than a filling.": "İmplant ağrılı mı? Hastalarımız dolgudan daha kolay olduğunu söylüyor.",
    "One missing tooth changes your bite. Here is how an implant fixes it.": "Tek bir eksik diş kapanışınızı değiştirir. İmplantın bunu nasıl düzelttiğini anlatıyoruz.",
    "Implant or bridge? A two-minute answer from our lead dentist.": "İmplant mı, köprü mü? Baş hekimimizden iki dakikalık yanıt.",
    "Six months, one treatment plan, a smile she finally shows off.": "Altı ay, tek tedavi planı ve artık gönül rahatlığıyla gösterdiği bir gülüş.",
    "Real patient, real result — swipe to see the transformation.": "Gerçek hasta, gerçek sonuç — değişimi görmek için kaydırın.",
    "She stopped hiding her teeth in photos — her full story is on our page.": "Fotoğraflarda dişlerini saklamayı bıraktı — tüm hikâyesi sayfamızda.",
    "Pick a topic once. The AI writes the posts, applies your brand kit, fills the week and publishes on time.": "Konuyu bir kez seçin. AI gönderileri yazar, marka kitinizi uygular, haftayı doldurur ve zamanında yayınlar.",

    "Photo → AI smile preview in ~15s": "Fotoğraf → AI gülüş önizlemesi ~15 sn",
    "Posts created & auto-published while you treat patients": "Siz hastalarınızla ilgilenirken gönderiler oluşturulur ve otomatik yayınlanır",
    "Works on any clinic account": "Her klinik hesabında çalışır",
    "Monthly · cancel anytime": "Aylık · istediğiniz zaman iptal",

    "Pick your module. Add the other whenever you want.": "Modülünüzü seçin. Diğerini istediğiniz zaman ekleyin.",
    "Every module is standalone, billed monthly, and works on any clinic account.": "Her modül bağımsızdır, aylık faturalandırılır ve her klinik hesabında çalışır.",
    "Most popular": "En popüler",
    "$228/mo": "$228/ay",
    "Both modules · one monthly bill": "Her iki modül · tek aylık fatura",
    "Monthly subscription · no free trial · cancel anytime": "Aylık abonelik · ücretsiz deneme yok · istediğiniz zaman iptal",

    "What's included where": "Hangi pakette ne var",
    "Two modules cover patient attraction. The full platform adds the front desk behind it.": "İki modül hasta çekme tarafını kapsar. Tam platform ise arkasındaki ön büroyu ekler.",
    "Capability": "Özellik",
    "Smile Design": "Gülüş Tasarımı",
    "Social Media": "Sosyal Medya",
    "Bundle": "Paket",
    "Full Platform": "Tam Platform",
    "AI Chat Assistant": "AI Chat Asistanı",
    "CRM & lead pipeline": "CRM ve lead pipeline",
    "WhatsApp & Instagram inbox": "WhatsApp ve Instagram gelen kutusu",
    "Automations": "Otomasyonlar",
    "Monthly price": "Aylık fiyat",

    "Clinics already running the modules": "Modülleri şimdiden kullanan klinikler",
    "Replace the placeholders below with real quotes once your first module clinics approve them.": "Aşağıdaki yer tutucuları, ilk modül kliniklerinizin onayı geldikten sonra gerçek yorumlarla değiştirin.",
    "[Clinic testimonial — Smile Design]": "[Klinik yorumu — Gülüş Tasarımı]",
    "[Clinic testimonial — Social Media AI]": "[Klinik yorumu — Sosyal Medya AI]",
    "[Clinic testimonial — Clinic Bundle]": "[Klinik yorumu — Klinik Paketi]",
    "[Clinic name · city]": "[Klinik adı · şehir]",
    "[Clinic logo]": "[Klinik logosu]",

    "No contract": "Sözleşme yok",
    "Cancel anytime": "İstediğiniz zaman iptal",
    "Instant access": "Anında erişim",
    "Works on any account": "Her hesapta çalışır",
    "Questions clinics ask before buying": "Kliniklerin satın almadan önce sorduğu sorular",
    "Do I need the full platform?": "Tam platforma ihtiyacım var mı?",
    "No. Each module is a standalone AI tool that works on any clinic account — you can run Smile Design or Social Media AI without the STOAIX platform subscription.": "Hayır. Her modül, her klinik hesabında çalışan bağımsız bir AI aracıdır — Gülüş Tasarımı veya Sosyal Medya AI'yı STOAIX platform aboneliği olmadan kullanabilirsiniz.",
    "Is there a free trial?": "Ücretsiz deneme var mı?",
    "No free trial on modules. They are billed monthly and you can cancel anytime, so the shortest possible commitment is a single month.": "Modüllerde ücretsiz deneme yoktur. Aylık faturalandırılır ve istediğiniz zaman iptal edebilirsiniz; yani mümkün olan en kısa taahhüt tek bir aydır.",
    "How fast do I get access?": "Erişimi ne kadar sürede alırım?",
    "Instantly. Your module is active on your account the moment the payment goes through — no onboarding call needed to start.": "Anında. Ödeme onaylandığı anda modül hesabınızda aktif olur — başlamak için tanıtım görüşmesi gerekmez.",
    "Can I add modules later?": "Sonradan modül ekleyebilir miyim?",
    "Yes. Start with one, add the second whenever you want. If you take both, the Clinic Bundle price applies from your next billing cycle.": "Evet. Biriyle başlayın, ikincisini istediğiniz zaman ekleyin. İkisini de alırsanız bir sonraki fatura döneminden itibaren Klinik Paketi fiyatı uygulanır.",
    "How do I cancel?": "Nasıl iptal ederim?",
    "One click in your account settings. No lock-in, no cancellation fee — your module stays active until the end of the paid month.": "Hesap ayarlarınızdan tek tıkla. Bağlayıcılık ve iptal ücreti yok — modülünüz ödenmiş ayın sonuna kadar aktif kalır.",
  ...
  /* ─── modules-smile-design.html ───────────────────────── */
  const TR_MODULES_SMILE = Object.assign({}, TR_COMMON, {
    "AI Smile Design — STOAIX": "AI Gülüş Tasarımı — STOAIX",
    "AI Smile Design": "AI Gülüş Tasarımı",
    "Most patients who say they'll think about it never come back.": "Düşüneceğini söyleyen hastaların çoğu bir daha geri dönmez.",
    "AI Smile Design turns their photo into their new smile in seconds and sends it to their WhatsApp — automatically the moment they message, or manually with one tap — so they book while they're still excited.": "AI Gülüş Tasarımı, hastanın fotoğrafını saniyeler içinde yeni gülüşüne çevirir ve WhatsApp'ına gönderir — mesaj attığı anda otomatik ya da tek dokunuşla manuel olarak — böylece hasta hâlâ heyecanlıyken randevu alır.",
    "Buy Smile Design": "Gülüş Tasarımını Al",
    "See how it works": "Nasıl çalıştığını görün",
    "$99/mo · cancel anytime": "$99/ay · istediğiniz zaman iptal",
    "Works on any clinic account": "Her klinik hesabında çalışır",
    ...
    "How it works": "Nasıl çalışır",
    "Three steps, about fifteen seconds, no design skills needed.": "Üç adım, yaklaşık on beş saniye, tasarım bilgisi gerekmez.",
    "Patient photo": "Hasta fotoğrafı",
    "Upload the photo": "Fotoğrafı yükleyin",
    "Take it on a phone or drop in a photo the patient already sent you on WhatsApp.": "Telefonla çekin ya da hastanın size WhatsApp'tan gönderdiği fotoğrafı ekleyin.",
    "AI processing": "AI işliyor",
    "AI designs the smile": "AI gülüşü tasarlar",
    "The model aligns, shapes and brightens the teeth and returns a realistic preview.": "Model dişleri hizalar, biçimlendirir ve beyazlatır; gerçekçi bir önizleme döndürür.",
    "Share on WhatsApp": "WhatsApp'tan paylaş",
    "Send it to the patient": "Hastaya gönderin",
    "One tap sends the before/after straight into the chat, with your clinic's booking link.": "Tek dokunuş, öncesi/sonrası görselini kliniğinizin randevu bağlantısıyla birlikte doğrudan sohbete gönderir.",

    "Why it converts": "Neden dönüşüm sağlar",
    "Patients hesitate because they cannot picture the result. This removes that.": "Hastalar sonucu gözlerinde canlandıramadıkları için tereddüt eder. Bu, o engeli kaldırır.",
    "Before/after visuals drive bookings": "Öncesi/sonrası görseller randevu getirir",
    "A side-by-side preview answers the only question that matters — what will I look like — without a consultation slot.": "Yan yana önizleme, tek önemli soruyu — nasıl görüneceğim — bir muayene randevusuna gerek kalmadan yanıtlar.",
    "Automatic & manual WhatsApp delivery": "Otomatik ve manuel WhatsApp gönderimi",
    "Send previews automatically the moment a patient sends a photo, or manually with one tap — the follow-up happens right inside the chat, while interest is high.": "Önizlemeleri, hasta fotoğraf gönderdiği anda otomatik ya da tek dokunuşla manuel gönderin — takip, ilgi yüksekken doğrudan sohbetin içinde gerçekleşir.",
    "A live preview in seconds": "Saniyeler içinde canlı önizleme",
    "No lab, no waiting on a technician. Your team can run a preview mid-conversation and keep the momentum.": "Laboratuvar yok, teknisyen beklemek yok. Ekibiniz konuşmanın ortasında önizleme alıp ivmeyi koruyabilir.",

    "Sample previews": "Örnek önizlemeler",
    "Placeholder pairs — swap in your own approved patient cases before publishing.": "Yer tutucu çiftler — yayına almadan önce onaylı kendi hasta vakalarınızla değiştirin.",
    "Before": "Öncesi",
    "After": "Sonrası",
    "[Patient case placeholder]": "[Hasta vakası yer tutucusu]",

    "Monthly subscription · no free trial · cancel anytime": "Aylık abonelik · ücretsiz deneme yok · istediğiniz zaman iptal",
    "AI smile simulation": "AI gülüş simülasyonu",
    "Before/after gallery": "Öncesi/sonrası galerisi",
    "One-click WhatsApp share": "Tek tıkla WhatsApp paylaşımı",
    "Instant access on any clinic account": "Her klinik hesabında anında erişim",
    "← Back to all modules": "← Tüm modüllere dön",
    "/mo": "/ay",

    "Questions about Smile Design": "Gülüş Tasarımı hakkında sorular",
    "What kind of photo does it need?": "Nasıl bir fotoğraf gerekiyor?",
    "A clear, front-facing photo of the patient smiling. A phone camera is enough — no special lighting or equipment.": "Hastanın gülümsediği, net ve önden çekilmiş bir fotoğraf yeterlidir. Telefon kamerası yeterli — özel ışık veya ekipman gerekmez.",
    "Is the preview a clinical treatment plan?": "Önizleme klinik bir tedavi planı mıdır?",
  ...
  const TR_MODULES_SOCIAL = Object.assign({}, TR_COMMON, {
    "Social Media AI — STOAIX": "Sosyal Medya AI — STOAIX",
    "Social Media AI": "Sosyal Medya AI",
    "You don't need a social media manager.": "Sosyal medya yöneticisine ihtiyacınız yok.",
    "AI Social Media runs your Instagram and Facebook exactly the way you want — writing captions, designing on-brand posts, scheduling and auto-publishing — for far less than a social media manager's salary.": "AI Sosyal Medya, Instagram ve Facebook'unuzu tam istediğiniz gibi yönetir — metinleri yazar, markanıza uygun gönderiler tasarlar, planlar ve otomatik yayınlar — bir sosyal medya yöneticisi maaşının çok altına.",
    "Buy Social Media AI": "Sosyal Medya AI'yı Al",
    "See how it works": "Nasıl çalıştığını görün",
    "$129/mo · cancel anytime": "$129/ay · istediğiniz zaman iptal",
    "Instagram & Facebook": "Instagram ve Facebook",
    ...
    "How it works": "Nasıl çalışır",
    "You brief it once and stay in control — approve every post, or let it run fully automatic.": "Bir kez brief verirsiniz ve kontrol sizde kalır — her gönderiyi onaylayın ya da tamamen otomatik çalıştırın.",
    "Whitening": "Beyazlatma",
    "Implants": "İmplant",
    "Brief the AI": "AI'ya brief verin",
    "Pick the treatments you want to promote and the tone your clinic speaks in. That is the whole setup.": "Öne çıkarmak istediğiniz tedavileri ve kliniğinizin ses tonunu seçin. Kurulum bundan ibaret.",
    "AI creates": "AI üretir",
    "AI writes and styles": "AI yazar ve tasarlar",
    "Captions, hashtags and visuals are generated in your brand colours and typography, ready to review.": "Metinler, etiketler ve görseller marka renkleriniz ve tipografinizle üretilir, incelemeye hazır olur.",
    "Schedules & auto-publishes": "Planlar ve otomatik yayınlar",
    "Posts are placed at the best times of the week and published to Instagram and Facebook automatically.": "Gönderiler haftanın en uygun saatlerine yerleştirilir ve Instagram ile Facebook'ta otomatik yayınlanır.",

    "Every post looks like your clinic": "Her gönderi kliniğinize benzer",
    ...
    "Post 2": "Gönderi 2",
    "Post 3": "Gönderi 3",
    "Brand colour applied to the cover and the caption card.": "Marka rengi kapağa ve metin kartına uygulanır.",
    "Secondary colour keeps the feed varied but consistent.": "İkincil renk akışı çeşitlendirir ama tutarlı tutar.",
    "Neutral sand background for testimonial and quote posts.": "Yorum ve alıntı gönderileri için nötr kum zemin.",

    "A full week, planned before Monday": "Pazartesiden önce planlanmış tam bir hafta",
    "You see the whole schedule in advance and can swap or approve anything with one click.": "Tüm takvimi önceden görürsünüz ve tek tıkla herhangi bir gönderiyi değiştirebilir veya onaylayabilirsiniz.",
    "Whitening offer": "Beyazlatma kampanyası",
    "Team spotlight": "Ekip tanıtımı",
    "Before & after": "Öncesi ve sonrası",
    "Aftercare tip": "Bakım önerisi",
    ...
    "Questions about Social Media AI": "Sosyal Medya AI hakkında sorular",
    "Do I approve posts before they go out?": "Gönderiler yayınlanmadan önce onaylıyor muyum?",
    "Your choice. Run it fully automatic, or keep approval on and review the week's posts in one pass before they publish.": "Seçim sizin. Tamamen otomatik çalıştırabilir ya da onayı açık tutup haftanın gönderilerini yayınlanmadan önce tek seferde inceleyebilirsiniz.",
    "Which channels does it publish to?": "Hangi kanallarda yayınlıyor?",
  ...
  const DICT_MAP = {
    '/modules': TR_MODULES,
    '/modules-smile-design': TR_MODULES_SMILE,
    '/modules-social-media': TR_MODULES_SOCIAL,
