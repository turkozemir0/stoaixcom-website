...
const TR_DEMO = Object.assign({}, TR_COMMON, {
  /* Hero */
  'Interactive Demo': 'İnteraktif Demo',
  'Experience STOAIX — No Signup Required': 'STOAIX\'i Deneyimleyin — Kayıt Gerekmez',
  'Click around, explore features, and see how AI handles real patient conversations for an aesthetic clinic — in 15+ languages.': 'Tıklayın, özellikleri keşfedin ve AI\'ın bir estetik klinik için gerçek hasta konuşmalarını 15+ dilde nasıl yönettiğini görün.',
  /* Sidebar nav */
  ...
  'Settings': 'Ayarlar',
  /* Sidebar footer */
  'AI Resolution': 'AI Çözüm',
  'Languages': 'Dil',
  /* Overview */
  "Today's Summary": 'Bugünün Özeti',
  "Today's Conversations": 'Bugünkü Konuşmalar',
  'Active Leads': 'Aktif Leadler',
  'Voice Calls': 'Sesli Aramalar',
  'AI Resolution Rate': 'AI Çözüm Oranı',
  'Conversion Rate': 'Dönüşüm Oranı',
  'Language Diversity': 'Dil Çeşitliliği',
  '15 langs': '15 dil',
  '↑ 18% this week': '↑ 18% bu hafta',
  '↑ 3 new today': '↑ 3 yeni bugün',
  '↑ 2 today': '↑ 2 bugün',
  '↑ 5% this month': '↑ 5% bu ay',
  '↑ 23% this month': '↑ 23% bu ay',
  /* Activity feed */
  'Recent Activities': 'Son Aktiviteler',
  'Today': 'Bugün',
  'Ayşe G. started a conversation via WhatsApp': 'Ayşe G. WhatsApp\'tan konuşma başlattı',
  'James W. created a Botox appointment': 'James W. Botox randevusu oluşturdu',
  'Hans M. moved to Hot Lead stage': 'Hans M. Hot Lead aşamasına geçti',
  'Анна К. voice call completed (3:47 min)': 'Анна К. ile sesli görüşme tamamlandı (3:47 dk)',
  'فاطمة س. added as new lead': 'فاطمة س. yeni lead olarak eklendi',
  'Marie D. inquired about PRP treatment': 'Marie D. PRP tedavisi hakkında bilgi aldı',
  'Carlos R. selected laser hair removal package': 'Carlos R. lazer epilasyon paketi seçti',
  'Sofia L. skincare procedure completed → Converted': 'Sofia L. cilt bakımı işlemi tamamlandı → Dönüştü',
  'Mehmet K. rhinoplasty appointment confirmed': 'Mehmet K. rinoplasti randevusu onaylandı',
  'Yuki T. 🇯🇵 new lead — botox info request': 'Yuki T. 🇯🇵 yeni lead — botox bilgi talebi',
  'Ali R. 🇮🇷 hair transplant inquiry via WhatsApp': 'Ali R. 🇮🇷 WhatsApp\'tan saç ekimi sorgusu',
  'Elena P. 🇵🇹 moved to Nurturing stage': 'Elena P. 🇵🇹 Nurturing aşamasına taşındı',
  'Kim S. 🇰🇷 inquired about skincare package': 'Kim S. 🇰🇷 cilt bakımı paketi hakkında bilgi aldı',
  '2 min ago': '2 dk önce',
  '15 min ago': '15 dk önce',
  '32 min ago': '32 dk önce',
  '1 hour ago': '1 saat önce',
  '2 hours ago': '2 saat önce',
  '3 hours ago': '3 saat önce',
  '4 hours ago': '4 saat önce',
  '5 hours ago': '5 saat önce',
  '6 hours ago': '6 saat önce',
  '7 hours ago': '7 saat önce',
  /* Chart */
  'Weekly Conversations': 'Haftalık Konuşmalar',
  ...
  'Sun': 'Paz',
  /* Inbox */
  'Search conversations...': 'Konuşma ara...',
  'Select a conversation to see how AI manages patients.': 'AI\'ın hastaları nasıl yönettiğini görmek için bir konuşma seçin.',
  /* Calls view */
  'Voice AI call recordings': 'Sesli AI görüşme kayıtları',
  'Listen Demo': 'Demo Dinle',
  'Contact': 'Kişi',
  'Direction': 'Yön',
  'Duration': 'Süre',
  'Handled By': 'İşleyen',
  ...
  '✗ Missed': '✗ Cevapsız',
  /* Call summary */
  '📞 Ayşe G. — Call Summary & Sales Recommendation': '📞 Ayşe G. — Arama Özeti & Satış Önerisi',
  'Conversation Summary': 'Konuşma Özeti',
  'Ayşe is researching hair transplant for her husband. Showed interest in DHI technique. Budget: €3,000-4,000. Requested package pricing including Istanbul transportation and accommodation.': 'Ayşe Hanım eşi için saç ekimi araştırıyor. DHI tekniğine ilgi gösterdi. Bütçe: 3.000-4.000€. İstanbul\'a ulaşım ve konaklama dahil paket fiyatı talep etti.',
  'Collected Information': 'Toplanan Bilgiler',
  'Patient:': 'Hasta:',
  'Husband (male, 35-40 yrs)': 'Eşi (erkek, 35-40 yaş)',
  'Preference:': 'Tercih:',
  'DHI method': 'DHI yöntemi',
  'Budget:': 'Bütçe:',
  'Location:': 'Konum:',
  'Ankara': 'Ankara',
  'Timeline:': 'Zaman:',
  'June': 'Haziran',
  'Sales Closing Recommendation': 'Satış Kapatma Önerisi',
  '🎯 Recommendation:': '🎯 Öneri:',
  'Patient is high-intent (score: 88). Offer DHI All-Inclusive package (€3,500). Request photos today — send personalized analysis report within 24 hours.': 'Hasta yüksek niyetli (skor: 88). DHI All-Inclusive paket teklif edin (3.500€). Fotoğrafları bugün isteyin — 24 saat içinde kişisel analiz raporu gönderin.',
  /* Pipeline */
  'Track your prospective patients': 'Hasta adaylarını takip edin',
  'New': 'Yeni',
  'Filler': 'Dolgu (Filler)',
  'PRP Treatment': 'PRP Tedavisi',
  'Skincare': 'Cilt Bakımı',
  'Botox & Filler': 'Botox & Dolgu',
  'Rhinoplasty': 'Rinoplasti',
  'Laser Hair Removal': 'Lazer Epilasyon',
  'Hair Transplant (FUE)': 'Saç Ekimi (FUE)',
  'Hair Transplant (Sapphire)': 'Saç Ekimi (Safir)',
  'Hair Transplant (DHI)': 'Saç Ekimi (DHI)',
  'Skincare & Peel': 'Cilt Bakımı & Peeling',
  'Botox Full Face': 'Botox Full Face',
  '📅 Appointment': '📅 Randevu',
  '✅ Converted': '✅ Dönüştü',
  /* AI Assistant */
  'Knowledge base and test playground': 'Bilgi bankası ve test ekranı',
  'Knowledge Base': 'Bilgi Bankası',
  'Test Playground': 'Test Ekranı',
  '8 items': '8 öğe',
  '+ Add New': '+ Yeni Ekle',
  'Hair Transplant Services (FUE, DHI, Sapphire)': 'Saç Ekimi Hizmetleri (FUE, DHI, Safir)',
  'Botox & Filler Treatments': 'Botox & Dolgu Uygulamaları',
  'Laser Hair Removal Packages': 'Lazer Epilasyon Paketleri',
  'Rhinoplasty Information': 'Rinoplasti Bilgilendirme',
  'PRP & Mesotherapy': 'PRP & Mezoterapi',
  'FAQ: Recovery Process & Eligibility': 'SSS: İyileşme Süreci & Uygunluk',
  'Price List 2026': 'Fiyat Listesi 2026',
  'Service': 'Hizmet',
  'FAQ': 'SSS',
  'Pricing': 'Fiyatlandırma',
  '12 items': '12 öğe',
  ...
  /* Playground */
  'Chat Test': 'Chat Test',
  'Written conversation simulation': 'Yazılı konuşma simülasyonu',
  'Voice Test': 'Sesli Test',
  'Voice AI call simulation': 'Sesli AI arama simülasyonu',
  'Chat Playground': 'Chat Playground',
  "Hello! I'm the AI assistant of Stoaix Clinic. I can help with hair transplant, botox, laser, rhinoplasty and other aesthetic services. How can I help you?": 'Merhaba! Ben Stoaix Clinic\'in AI asistanıyım. Saç ekimi, botox, lazer, rinoplasti ve diğer estetik hizmetlerimiz hakkında bilgi verebilirim. Nasıl yardımcı olabilirim?',
  'Type a message...': 'Bir mesaj yazın...',
  'Voice Assistant Ready': 'Sesli Asistan Hazır',
  'Click to start a voice conversation with AI': 'Tıklayarak AI ile sesli konuşma başlatın',
  'Turkish': 'Türkçe',
  'German': 'Deutsch',
  'Russian': 'Русский',
  '+11 languages': '+11 dil',
  /* Workflows */
  'Automated AI processes': 'Otomatik AI süreçleri',
  'First Contact Call': 'İlk Temas Araması',
  'AI calls new leads within 60 seconds for qualification and appointment booking': 'Yeni leadlere 60 saniye içinde AI arama yaparak nitelendirme ve randevu oluşturma',
  'Active': 'Aktif',
  '47 runs': '47 çalıştırma',
  'Warm Follow-up': 'Sıcak Takip',
  "Automatically send follow-up messages to leads who haven't responded in 24 hours": '24 saat içinde yanıt vermeyen leadlere otomatik takip mesajı gönderme',
  '124 runs': '124 çalıştırma',
  'Appointment Reminder': 'Randevu Hatırlatma',
  'Send voice reminders 24 hours and 2 hours before appointments': 'Randevudan 24 saat ve 2 saat önce sesli hatırlatma gönderme',
  '89 runs': '89 çalıştırma',
  'No-Show Follow-up': 'Randevuya Gelmedi Takibi',
  'Make personalized calls to patients who missed their appointment': 'Randevusunu kaçıran hastalara kişiselleştirilmiş arama yapma',
  '23 runs': '23 çalıştırma',
  'Satisfaction Survey': 'Memnuniyet Anketi',
  'Collect feedback via post-procedure satisfaction calls': 'İşlem sonrası memnuniyet araması ile geri bildirim toplama',
  'Draft': 'Taslak',
  '12 runs': '12 çalıştırma',
  'Reactivation': 'Reaktivasyon',
  "Re-engage old patients who haven't been contacted in 90+ days": '90+ gündür iletişim kurulmayan eski hastalara tekrar ulaşma',
  '35 runs': '35 çalıştırma',
  /* Settings */
  'Clinic info and configuration': 'Klinik bilgileri ve yapılandırma',
  'General': 'Genel',
  'Modules': 'Modüller',
  'Plan & Billing': 'Plan & Fatura',
  'Pipelines': 'Pipelinelar',
  'Support': 'Destek',
  'Clinic Name': 'Klinik Adı',
  'Name shown in dashboard and messages': 'Dashboard ve mesajlarda görünen isim',
  'Email': 'E-posta',
  'Notifications and communication': 'Bildirimler ve iletişim',
  'Phone': 'Telefon',
  'Primary contact line': 'Birincil iletişim hattı',
  'City / Country': 'Şehir / Ülke',
  'Istanbul, Turkey': 'İstanbul, Türkiye',
  'Industry': 'Sektör',
  'Clinic': 'Klinik',
  'AI Language': 'AI Dili',
  "Assistant's default language": 'Asistanın varsayılan dili',
  'Turkish (Auto-detection on)': 'Türkçe (Otomatik algılama açık)',
  'Timezone': 'Zaman Dilimi',
  'Enable or disable modules included in your plan.': 'Planınıza dahil modülleri aktif/pasif yapabilirsiniz.',
  'AI replies to incoming WhatsApp messages': 'Gelen WhatsApp mesajlarına AI yanıt',
  'Voice AI (Inbound)': 'Sesli AI (Gelen Arama)',
  'AI answers incoming phone calls': 'Gelen telefon aramalarını AI karşılasın',
  'Voice AI (Outbound)': 'Sesli AI (Giden Arama)',
  'AI makes automated calls': 'AI otomatik arama yapsın',
  'AI replies to Instagram messages': 'Instagram mesajlarına AI yanıt',
  'Lead Scoring': 'Lead Skorlama',
  'AI automatic lead scoring': 'AI otomatik lead puanlama',
  'Bulk lead upload': 'Toplu lead yükleme',
  'AI Conversations:': 'AI Konuşma:',
  'Users:': 'Kullanıcı:',
  'Billing Period': 'Fatura Dönemi',
  'Monthly · Next: June 1, 2026': 'Aylık · Sonraki: 1 Haziran 2026',
  'Payment Method': 'Ödeme Yöntemi',
  'Default Pipeline': 'Varsayılan Pipeline',
  'New → AI Qualifying → Hot Lead → Nurturing → Appointment → Converted → Lost': 'Yeni → AI Qualifying → Hot Lead → Nurturing → Randevu → Dönüştü → Kayıp',
  'Edit →': 'Düzenle →',
  'CRM Integration': 'CRM Entegrasyonu',
  'GoHighLevel connection': 'GoHighLevel bağlantısı',
  'Connected ✓': 'Bağlı ✓',
  'Auto Stage Transition': 'Otomatik Aşama Geçişi',
  'Automatically move leads based on AI score thresholds': 'AI skoru eşiklerine göre otomatik taşıma',
  'Need help?': 'Yardıma mı ihtiyacınız var?',
  'Our technical support team is available 24/7.': 'Teknik destek ekibimiz 7/24 yanınızda.',
  'Create Support Ticket': 'Destek Talebi Oluştur',
  /* STOA agent */
  "Hi, I'm STOA! Need any help? 👋": 'Merhaba, ben STOA! Yardıma ihtiyacınız var mı? 👋',
  'STOA Support Assistant': 'STOA Destek Asistanı',
  "Your clinic's AI assistant": 'Kliniğinize özel AI asistanınız',
  "Hi! I'm STOA, the AI support assistant of stoaix platform. 👋 How can I help you?": 'Merhaba! Ben STOA, stoaix platformunun AI destek asistanıyım. 👋 Size nasıl yardımcı olabilirim?',
  'Tell me about the platform': 'Platformu tanıtır mısın?',
  'Pricing info': 'Fiyatlar hakkında bilgi',
  'I need technical support': 'Teknik destek istiyorum',
  'Can I book a demo?': 'Demo randevusu alabilir miyim?',
  /* Bottom CTA */
  'Ready to transform your clinic?': 'Kliniğinizi dönüştürmeye hazır mısınız?',
  'Take your clinic to the next level with AI assistant in 15+ languages, automated workflows, and smart lead management.': '15+ dilde AI asistan, otomatik iş akışları ve akıllı lead yönetimi ile kliniğinizi geleceğe taşıyın.',
